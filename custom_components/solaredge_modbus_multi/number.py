...
async def async_setup_entry(
    ...
    for battery in hub.batteries:
        for inverter in hub.inverters:
            ...
            entities.append(StoredgeChargeLimit(inverter, battery, config_entry, coordinator))
            entities.append(StoredgeDischargeLimit(inverter, battery, config_entry, coordinator))
...
class StoredgeACChargeLimit(SolarEdgeNumberBase):
    ...
    def entity_registry_enabled_default(self) -> bool:
        ...
        if self._platform.decoded_storedge["ac_charge_policy"] in [2, 3]:
            return True
        else:
            return False
...
class StoredgeCommandTimeout(SolarEdgeNumberBase):
    ...
    def available(self) -> bool:
        ...
        return self._platform.online and self._platform.decoded_storedge["control_mode"] == 4
